...
class App(Tk):
    ...
    def get_value(self, number_LD):
        ...
        if number_LD == 1:
            ...
            self.PC_value = self.PC_content.cget("text")
            jj = self.convert_binary_to_decimal(self.PC_value[7:].zfill(12))#MAR_value
            ...
            for iii in range(4096):
                if self.PC_next < 4095:
                    self.instruction_controller(self.memory[jj])
            ...
            for abccc in range(0, 4095, 4):
                print("Address", abccc+1, ":", "value:", self.memory[abccc],"Address", abccc+2, ":", "value:", self.memory[abccc+1],"Address", abccc+3, ":", "value:", self.memory[abccc+2],"Address", abccc+3, ":", "value:", self.memory[abccc+3])
